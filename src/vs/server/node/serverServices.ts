...
import { KeytarCredentialsWebMainService } from 'vs/platform/credentials/node/credentialsMainService';
...
export async function setupServerServices(connectionToken: ServerConnectionToken, args: ServerParsedArgs, REMOTE_DATA_FOLDER: string, disposables: DisposableStore) {
	...
	services.set(ICredentialsMainService, new SyncDescriptor(KeytarCredentialsWebMainService));
